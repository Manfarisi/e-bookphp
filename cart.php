...
if (isset($_POST['update_cart'])) {
   ...
   // Ambil stok yang tersedia di tabel products
   ...
   // Cek apakah jumlah yang dimasukkan lebih dari stok
   if ($cart_quantity > $available_stock) {
      $message[] = 'Jumlah melebihi stok yang tersedia!';
   } else {
      // Update jumlah di keranjang jika sesuai
      mysqli_query($conn, "UPDATE `cart` SET quantity = '$cart_quantity' WHERE id = '$cart_id'") or die('query failed');
      $message[] = 'Jumlah dalam keranjang diperbarui!';
   }
}
...
if (isset($_POST['remove_from_cart'])) {
   ...
   // Hapus hanya satu produk dari keranjang berdasarkan ID
         ...
         ?>
               <div class="box">
                  ...
                  <form action="" method="post">
                     ...
                     <input type="hidden" name="product_penulis" value="<?php echo $fetch_cart['name']; ?>">
                     <input type="hidden" name="product_quantity" value="<?php echo $fetch_cart['quantity']; ?>">
                     <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>">
                     <input type="submit" name="update_cart" value="Update" class="option-btn">
                     <input type="submit" name="remove_from_cart" value="Batalkan Pesanan" class="btn" onclick="return confirm('Yakin ingin membatalkan pesanan ini?');">
                  </form>
